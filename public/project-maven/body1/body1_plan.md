...
주제: 프로젝트 메이븐의 탄생 배경과 구조 — "전쟁터의 유튜브 알고리즘"
내용 요약: 2017년 미국 국방부가 드론 영상 과부하 문제에 직면했음을 설명한다. 군사 드론이 쏟아내는 방대한 영상을 사람이 분석할 수 없어, AI 기반 필터링 시스템인 프로젝트 메이븐이 만들어졌다. 이를 "유튜브 알고리즘"에 비유하며 개념을 쉽게 설명하고, 구글의 초기 참여와 직원 반발로 인한 철수, 이후 팔란티어/AWS/마이크로소프트 등 10개사 참여 규모(계약액 최대 100억 달러)까지 전달한다.
...
- 원본 텍스트: 때는 2017년이에요.
- 단어 등장 프레임: "때는": 0f, "2017년이에요.": 18f
- 타임라인: 0f 부터 시작 (총 117f 지속)
...
- 단어 등장 프레임: "미국": 117f, "국방부가": 121f, "심각한": 151f, "고민에": 178f, "빠졌습니다.": 202f
- 타임라인: 117f 부터 시작 (총 142f 지속)
...
- 단어 등장 프레임: "\"드론이": 259f, "찍어오는": 289f, "영상이": 326f, "너무": 354f, "많아.": 373f
- 타임라인: 259f 부터 시작 (총 142f 지속)
...
- 단어 등장 프레임: "사람이": 401f, "다": 441f, "볼": 442f, "수가": 451f, "없어.\"": 470f
- 타임라인: 401f 부터 시작 (총 95f 지속)
...
- 원본 텍스트: 생각해보세요.
- 단어 등장 프레임: "생각해보세요.": 496f
- 타임라인: 496f 부터 시작 (총 78f 지속)
...
- 단어 등장 프레임: "전": 574f, "세계에": 580f, "깔린": 613f, "군사": 632f, "드론이": 681f, "하루": 701f, "24시간": 740f, "영상을": 770f, "찍어서": 800f, "쏟아붓는": 838f, "거예요.": 886f
- 타임라인: 574f 부터 시작 (총 312f 지속)
...
- 단어 등장 프레임: "그걸": 886f, "사람이": 928f, "한": 932f, "명": 937f, "한": 952f, "명": 954f, "앉아서": 962f, "들여다보고": 988f, "있으면": 1031f, "어느": 1057f, "세월에": 1074f, "다": 1099f, "보겠어요.": 1108f
- 타임라인: 886f 부터 시작 (총 271f 지속)
...
- 단어 등장 프레임: "\"이거": 1157f, "군사": 1175f, "차량이야,": 1195f, "민간": 1243f, "차량이야?\"": 1262f
- 타임라인: 1157f 부터 시작 (총 152f 지속)
...
- 단어 등장 프레임: "이러다가": 1309f, "전쟁이": 1357f, "먼저": 1376f, "끝나는": 1396f, "거죠.": 1427f
- 타임라인: 1309f 부터 시작 (총 165f 지속)
...
- 단어 등장 프레임: "그래서": 1474f, "만든": 1514f, "게": 1515f, "프로젝트": 1523f, "메이븐이에요.": 1558f
- 타임라인: 1474f 부터 시작 (총 145f 지속)
...
- 원본 텍스트: 비유하자면요
- 단어 등장 프레임: "비유하자면요,": 1619f
- 타임라인: 1619f 부터 시작 (총 68f 지속)
...
- 단어 등장 프레임: "\"전쟁터의": 1687f, "유튜브": 1748f, "알고리즘\"": 1756f, "이에요.": 1843f
- 타임라인: 1687f 부터 시작 (총 156f 지속)
...
- 단어 등장 프레임: "유튜브가": 1843f, "영상": 1889f, "수백만": 1901f, "개": 1920f, "중에서": 1928f, "내": 1954f, "취향에": 1963f, "맞는": 1988f, "걸": 2007f, "골라주잖아요.": 2014f
- 타임라인: 1843f 부터 시작 (총 239f 지속)
...
- 단어 등장 프레임: "메이븐은": 2082f, "드론": 2126f, "영상": 2138f, "수천": 2158f, "시간": 2177f, "중에서": 2199f, "\"위험한": 2225f, "것\"만": 2253f, "걸러내는": 2275f, "거예요.": 2311f
- 타임라인: 2082f 부터 시작 (총 276f 지속)
...
- 원본 텍스트: 방식은 다르지만 원리는 비슷합니다.
- 단어 등장 프레임: (timestamp 데이터 없음—startFrame 2358, durationInFrames 0으로 Bridge 처리)
- 타임라인: 2358f 부터 시작 (총 0f 지속, Bridge Scene)
- 비주얼 컨셉: 지속 프레임이 0이므로 실제 렌더링 없음. 다음 Scene으로 자연스럽게 전환.

Scene 16

- 원본 텍스트: 근데 이게 처음부터 잘 된 건 아니에요.
- 단어 등장 프레임: "근데": 2358f, "이게": 2375f, "처음부터": 2403f, "잘": 2430f, "된": 2439f, "건": 2448f, "아니에요.": 2457f
- 타임라인: 2358f 부터 시작 (총 145f 지속)
...
- 단어 등장 프레임: "처음엔": 2503f, "구글이": 2530f, "기술을": 2560f, "제공했어요.": 2589f
- 타임라인: 2503f 부터 시작 (총 148f 지속)
...
- 단어 등장 프레임: "근데": 2651f, "구글": 2680f, "직원들이": 2690f, "들고": 2729f, "일어났거든요.": 2749f
- 타임라인: 2651f 부터 시작 (총 171f 지속)
...
- 단어 등장 프레임: "\"우리": 2822f, "AI를": 2837f, "전쟁에": 2853f, "쓴다고?": 2882f
- 타임라인: 2822f 부터 시작 (총 98f 지속)
...
- 단어 등장 프레임: "우리는": 2920f, "그거": 2958f, "동의": 2970f, "못": 2992f, "해.\"": 3018f
- 타임라인: 2920f 부터 시작 (총 98f 지속)
...
- 단어 등장 프레임: "결국": 3018f, "구글은": 3037f, "2019년에": 3067f, "손을": 3128f, "떼고": 3148f, "나왔어요.": 3164f
- 타임라인: 3018f 부터 시작 (총 256f 지속)
...
- 단어 등장 프레임: "그래도": 3274f, "프로젝트": 3296f, "메이븐은": 3328f, "멈추지": 3359f, "않았습니다.": 3382f
- 타임라인: 3274f 부터 시작 (총 163f 지속)
...
- 단어 등장 프레임: "지금은": 3437f, "팔란티어라는": 3457f, "데이터": 3497f, "분석": 3518f, "회사가": 3530f, "핵심을": 3550f, "맡고": 3569f, "있어요.": 3583f
- 타임라인: 3437f 부터 시작 (총 183f 지속)
...
- 단어 등장 프레임: "AWS,": 3620f, "마이크로소프트": 3635f, "포함해서": 3706f, "10개": 3741f, "회사가": 3770f, "같이": 3799f, "붙어": 3818f, "있고요.": 3880f
- 타임라인: 3620f 부터 시작 (총 260f 지속)
...
- 원본 텍스트: 규모가 어느 정도냐면요
- 단어 등장 프레임: "규모가": 3880f, "어느": 3928f, "정도냐면요,": 3931f
- 타임라인: 3880f 부터 시작 (총 117f 지속)
- 비주얼 컨셉: 화면 전환 + "SCALE" 레이블 TEXT_MUTED SIZE_SM으로 왼→오른 slide-in. 배경에 수직 스케일 눈금선이 서서히 등장하며 다음 씬(계약 규모 공개)의 빌드업.

Scene 26 (= 타임라인 sentences index 24)

- 원본 텍스트: 팔란티어 혼자 미 국방부와 맺은 계약 규모가 최대 100억 달러
- 단어 등장 프레임: "팔란티어": 3997f, "혼자": 4029f, "미": 4045f, "국방부와": 4053f, "맺은": 4088f, "계약": 4100f, "규모가": 4115f, "최대": 4139f, "100억": 4156f, "달러,": 4191f
- 타임라인: 3997f 부터 시작 (총 223f 지속)
...
Scene 27 (= 타임라인 sentences index 25)

- 원본 텍스트: 우리 돈으로 약 13조 원 수준이에요.
- 단어 등장 프레임: "우리": 4220f, "돈으로": 4246f, "약": 4264f, "13조": 4272f, "원": 4302f, "수준이에요.": 4306f
- 타임라인: 4220f 부터 시작 (총 138f 지속)
- 비주얼 컨셉: "$10B" 숫자 아래에 "≈ ₩13조" 환산값이 TEXT_MUTED SIZE_LG로 slide-in. 좌측에 환율 변환 방향 화살표(→) 라인. 단순하고 임팩트 있는 숫자 대비 표현.

Scene 28 (= 타임라인 sentences index 26)

- 원본 텍스트: 이게 장난이 아닌 거죠.
- 단어 등장 프레임: "이게": 4358f, "장난이": 4390f, "아닌": 4402f, "거죠.": 4418f
- 타임라인: 4358f 부터 시작 (총 118f 지속)
