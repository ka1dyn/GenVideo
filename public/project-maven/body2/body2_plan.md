...
- 단어 등장 프레임: (durationInFrames 0, bridge)
- 타임라인: 4916f 부터 시작 (총 0f 지속)
- 비주얼 컨셉: durationInFrames가 0이므로 렌더링 없음. 다음 씬으로 전환.

Scene 26 (타임라인 25번째 sentence)

- 원본 텍스트: "AI 시스템의 판단에 대해 인간이 반드시 감독하고 개입한다."
- 단어 등장 프레임: "\"AI": 4916f, "시스템의": 4948f, "판단에": 4988f, "대해": 5018f, "인간이": 5025f, "반드시": 5065f, "감독하고": 5093f, "개입한다.\"": 5119f
- 타임라인: 4916f 부터 시작 (총 381f 지속)
