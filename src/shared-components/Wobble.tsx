...
interface WobbleProps {
  ...
  mode?: "jumpy" | "smooth";
  /** Intensity of the wobble in pixels (default: 1.0) */
  intensity?: number;
  /** How many frames between each wobble / frequency of sway (default: 4) */
  interval?: number;
  /** Rotation wobble in degrees (default: 0.3) */
 ...
 *
 * - "jumpy" mode: traditional boiling effect (random jumps every N frames)
 * - "smooth" mode: organic sine-wave sway
 */
