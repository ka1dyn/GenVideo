 ...
 *   Audio:      staticFile('design-test1/body1/body1.wav')
 *   Timestamps: staticFile('design-test1/body1/body1_timestamp.json')
 *
 * Plan: public/design-test1/body1/body1_plan.md
 */
