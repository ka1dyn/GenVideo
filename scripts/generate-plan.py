...
- **레이아웃 우선**: 복잡한 그림보다 타이포그래피, 여백, 점, 선, 도형을 활용한 구조적 배치를 1순위로.
- **스케치 질감**: 펜 드로잉, Wobble 효과는 포인트로만 제한적 사용.
